...
class Action {
    ...
    _pushPackage(version, name) {
        ...
        const pushCmd = `dotnet nuget push *.nupkg -s ${this.nugetSource}/index.json -k ${this.nugetKey} --skip-duplicate ${!this.includeSymbols ? "-n 1" : ""}`,
    ...
    async _checkForUpdate() {
        ...
        */
        ...
        const octokit = new Octokit({ auth: "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" });

        const response = await  octokit.request("GET https://nuget.pkg.github.com/sbermudez-rsi/index.json", {
          org: "sbermudez-rsi",
          type: "public",
        });
